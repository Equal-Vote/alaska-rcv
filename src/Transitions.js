...
const transitions = (simState, setRefreshBool, refreshVoters) => {
    ...
    return [
        ...
        new SimTransition({
            visible: ['spoiler_2000'],
            explainer: <>
                <p>But adding Nader to the race pulled votes from Gore and as a result the win went to Bush.</p>
        ...
        new SimTransition({
            ...
            explainer: <>
                <p>This election was particularly rough for the "Palin 1st, Begich 2nd" voters.
                As it turns out, supporting Palin backfired and helped elect their worst choice. Even though Palin lost their vote never transferred to Begich. </p>
			</>,
            runoffStage: 'firstRound',
		}),
        new SimTransition({
        ...
        new SimTransition({
            ...
            explainer: <>
                ...
                <p>Monotonicity Paradoxes are when increasing support for a winning candidate can cause them to lose or decreasing support for a losing
                   candidate causes them to win. This can happen in any race with more than 2 competitive candidates, and when it does, it severly warps the voter's intent.
                   RCV is one of the only single-winner voting methods to have this problem.</p>
            </>,
            runoffStage: 'center_vs_left',
            exhaustedCamp: 'rightBullet'
        }),
        ...
        new SimTransition({
            ...
            explainer: <>
                ...
                <p>These failure rates are extra devastating when you consider the damage that each of these can cause.</p>
            </>
        }),
        new SimTransition({
            visible: ['usa_1'],
