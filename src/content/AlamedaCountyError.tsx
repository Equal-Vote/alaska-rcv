...
export default () => [
    new SimTransition({
        explainer: 
        <>
            <p>Mistallies occurred across all of 2022 Alameda County elections, and this Oakland School Board election this error was enough to change the results.</p>
            <p>
                ...
                had been certified. At that time Resnick has already taken office and then resigned in order to avoid a lenghtly court procedure.
            </p>
            <p>
